...
useEffect(() => {
  ...
  const ProjectOr404 = () => {
    const { slug } = useParams();
      if (slug && userData.slug.length > 0 && userData.slug.some((s: { slug: string }) => s.slug === slug)) {
  ...
  const userData = useMemo(() => ({
    ...
    projects: [{"name":"Alphera Marine","description":"ERP system for a maritime company, streamlining their recruitment, crew deployment, and monitoring processes.","languages":["Php,Codeigniter,JavaScript,jQuery,MariaDB"],"updatedAt":"Current","image":"src/images/alphera_sc.jpg","id":"386","slug":"https://erp.alpheramarine.com/"}, {"name":"Polland IMS","description":"An Inventory Management System (IMS) for a famous Chinese goods and delicacies company, optimizing their inventory control and supply chain management.","languages":["Php,Laravel,JavaScript,jQuery,MariaDB, REST API"],"updatedAt":"Current","image":"src/images/polland_sc.jpg","id":"387","slug":"https://pollandhopiainventory.com/"},
    {"name":"Coeasy","description":"A Quiz system that focuses on improving students cohesion,comprehension and collaboration.","languages":["Php,Codeigniter,JavaScript,jQuery,MariaDB, Wordpress"],"updatedAt":"Current","image":"src/images/coeasy.png","id":"388","slug":"https://coeasy.website/landing/"},{"name":"Sipag","description":"An inhouse system that manages loans by employees planned to be release by year 2022 but hurdled due to the pandemic, currently on boiler.","languages":["Php,Codeigniter,JavaScript,jQuery,MariaDB, REST API"],"updatedAt":"2022","image":"src/images/sipagph_fav.jpg","id":"389","slug":"#"}], 
    work: [{"id":185,"company":"Springboard Ph","position":"Web Developer/Technical Project Manager","startDate":"02/2020","endDate":"Present","description":"https://drive.google.com/file/d/12lB3R89A4A-ETzyqrNQY7Ac672IUxRR3/view?usp=sharing","orderId":2,"image":"src/images/4141245.jpg"}],
    role: "USER",
    profession: "Web Developer",
    services: ["WEB_DEVELOPMENT","PROJECT_MANAGEMENT"],
    slug: [{"slug":"alphera-marine","header":"Alphera Marine","description":"ERP system for a maritime company, streamlining their recruitment, crew deployment, and monitoring processes.","image":"https://images.unsplash.com/photo-1517694712202-14dd9538aa97?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D","overview":"Overview","platforms":"Web","link":"https://erp.alpheramarine.com/"}, {"slug":"polland-ims","header":"Polland Inventory Management System","description":"An Inventory Management System (IMS) for a famous Chinese goods and delicacies company, optimizing their inventory control and supply chain management.","image":"https://images.unsplash.com/photo-1517694712202-14dd9538aa97?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D","overview":"Overview","platforms":"Web","link":"https://pollandhopiainventory.com/"},
...
const aboutData = useMemo(
        () => ({
          ...
          iconOne: "src/images/computer-engineer.png",
          ...
          headerTwo: "My story as a web developer",
          ...
          sections: [
            {
              type: "STORY",
              details: {
                headerOne: "My story as a web developer",
                descriptionOne: "Embarking on a journey fueled by curiosity and passion, I found solace in the world of code. From solving complex problems to creating user-friendly interfaces, every project has been a stepping stone in my development career. Continually learning and adapting, I've embraced new technologies and methodologies to build robust and efficient solutions. My path as a developer is more than a career; it's a lifelong pursuit of innovation, creativity, and technological advancement.",
