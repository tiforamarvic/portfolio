export const Services = [
              ...
              export const ServiceData: ServiceDataType = {
                WEB_DEVELOPMENT: {
                  description:
                    "I have more than 3 years of experience working as a web developer main focusing on backend development and am constantly willing to learn new skills in terms of web development. Also have experience with project deployment on Apache and Nginx servers under Linux distros.",
                ...
                PROJECT_MANAGEMENT: {
                  description:
                    "As a new project manager, I bring relevant experience from working with various developers and handling significant conglomerate projects. I am eager to learn and gain more experience in my role as a project manager, should the opportunity arise.",
